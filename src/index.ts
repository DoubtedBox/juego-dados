...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const nombreJugador1Input = document.getElementById("jugador1") as HTMLInputElement;
    const nombreJugador2Input = document.getElementById("jugador2") as HTMLInputElement;
    const marcadorDiv = document.getElementById("marcador") as HTMLDivElement;
    const resultadoDiv = document.getElementById("resultado") as HTMLDivElement;
    const dado1Img = document.getElementById("dado1") as HTMLImageElement;
    const dado2Img = document.getElementById("dado2") as HTMLImageElement;
    const currentPlayer = document.getElementById("current-player") as HTMLHeadingElement;
    const contadorRondaDiv = document.getElementById("contador-ronda") as HTMLDivElement;

    let juego: JuegoDados | null = null;
